...
const Top = () => {
  ...
  return (
    <Header
      ...
      p="md"
      style={{
        background: colorScheme === "dark" ? "#001518" : theme.colors.gray[0],
        borderColor: colorScheme === "dark" ? "#1c2a2d" : theme.colors.gray[0],
      }}
    >
      <div
        style={{
      ...
      >
            ...
            <ActionIcon
              ...
              style={
                theme.colorScheme === "dark"
                  ? { backgroundColor: "#012e27", borderColor: "#1c2a2d" }
                  : {}
              }
            >
              {colorScheme === "dark" ? (
        ...
        <div>
          <SegmentedControl
            ...
            color="green"
            style={
              theme.colorScheme === "dark" ? { backgroundColor: "#012e27" } : {}
            }
            data={[
              {
                value: "mint",
