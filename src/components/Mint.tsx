...
const Mint = () => {
  ...
  const gas = useGasPrice({ chainId: Chain.chainId });
    ...
    >
      ...
      <Input
        ...
        rightSection={
          loading ? (
            ...
            owner ? (
              <CopyButton value={`https://auro.la/#/${emoji}`}>
                {({ copied, copy }) => (
                  <Button
      ...
      <Paper radius="md" p="md" mt="md" withBorder>
        <Title
          ...
          variant="gradient"
          gradient={{
            from: theme.colorScheme === "dark" ? "#ff0091" : "#ff3986",
            to: theme.colorScheme === "dark" ? "#65ace8" : "#ff8c47",
            deg: 45,
          }}
        >
          Your AURORA SB Token
        </Title>
        {loading ? (
          <Box
            style={{
              ...
              >
                {emoji ? (
                  ...
                  <List spacing="xs" size="sm" center>
                    ...
                    >
                      Sending <span className={classes.highlight}>ETH</span>{" "}
